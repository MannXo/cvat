...
class TestWebhookUserEvents:
    ...
    def test_webhook_create_user_by_invitation(self, request: pytest.FixtureRequest) -> None:
        ...
        # An invitation creates a placeholder account for someone who has not
        # registered yet, and may never do so. created_via is what lets a
        # consumer tell that apart from a real registration.
